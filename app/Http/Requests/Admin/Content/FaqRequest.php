...
class FaqRequest extends ContentRequest
{
    ...
    public function __construct()
    {
        ...
        $this->tableCategory = (new FaqCategory)->getTable();
    }
    ...
    protected function storeRules(): array
    {
        ...
        return [
            ...
            'slug' => [
                'bail',
                ...explode('|', $this->stringRule(config('custom.length.faq.slug_max'))),
            ...
            'question' => 'bail|'.$this->stringRule(config('custom.length.faq.question_max'), true),
            'answer' => $this->stringRule(),
