...
class NewsCategoryRequest extends ContentRequest
{
    ...
    public function __construct()
    {
        ...
        $this->table = (new NewsCategory)->getTable();
    }
    ...
    protected function storeRules(): array
    {
        ...
        return [
            ...
            'slug' => [
                'bail',
                ...explode('|', $this->stringRule(config('custom.length.news_category.slug_max'))),
            ...
            'path' => $this->stringRule(config('custom.length.news_category.path_max')),
            'name' => 'bail|'.$this->stringRule(config('custom.length.news_category.name_max'), true),
            'sort' => $this->intRule(),
