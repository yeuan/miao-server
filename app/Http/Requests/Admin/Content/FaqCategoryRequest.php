...
class FaqCategoryRequest extends ContentRequest
{
    ...
    public function __construct()
    {
        ...
        $this->table = (new FaqCategory)->getTable();
    }
    ...
    protected function storeRules(): array
    {
        ...
        return [
            ...
            'slug' => [
                'bail',
                ...explode('|', $this->stringRule(config('custom.length.faq_category.slug_max'))),
            ...
            'path' => $this->stringRule(config('custom.length.faq_category.path_max')),
            'name' => 'bail|'.$this->stringRule(config('custom.length.faq_category.name_max'), true),
            'sort' => $this->intRule(),
